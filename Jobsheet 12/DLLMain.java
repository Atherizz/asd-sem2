...
public class DLLMain {
    ...
    public static Mahasiswa25 inputMahasiswa() {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (pilihan) {
                case 1:
                {
                    Mahasiswa25 mhs = inputMahasiswa();
                    list.addFirst(mhs);
                    break;
                }
                case 2:
                ...
                case 5:
                {
                   Mahasiswa25 data = list.removeFirst();
                   if (data != null) {
                ...
                case 6:
                {
                    Mahasiswa25 data = list.removeLast();
                    if (data != null) {
                    System.out.println("data mhs yang dihapus adalah : ");
                    data.tampilInformasi();
                   } else {
                ...
                case 12:
                {
                   ...
                   Mahasiswa25 mhs = list.getIndex(index);
                   if (mhs != null) {
                       mhs.tampilInformasi();
                    }
                   break;
